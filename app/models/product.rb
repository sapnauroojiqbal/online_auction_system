...
class Product < ApplicationRecord
  ...
  enum status: { unapproved: 'unapproved', approved: 'approved', live: 'live', sold: 'sold', rejected: 'rejected',
                 delivered: 'delivered' }

  has_many_attached :images, dependent: :destroy
  has_one_attached :preview_image, dependent: :destroy

  validates :name, :description, :preview_image, :images, presence: true
  validate :image_type
